...
var visit = function(version, scripts, callback, options) {
  if (options.localDependencies) {
    var can = require('can/dist/cjs/can');
    require('can/dist/cjs/view/mustache/mustache');
    require('can/dist/cjs/view/ejs/ejs');
    require('can/dist/cjs/view/stache/stache');
